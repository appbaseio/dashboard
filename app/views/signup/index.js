...
export default class Login extends Component {
	...
	render() {
		...
		return (
			<section id="signup" className="text-center container">
				<h2>
					{this.config.login.description}
				</h2>
				<p>
					Sign up to create an appbase.io app.<br/>
					- [ ] By creating an account, you agree to our <a href="https://appbase.io/tos">Terms of Service</a> and <a href="https://appbase.io/privacy">Privacy Policy</a>.<br/>
