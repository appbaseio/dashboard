	...
	render() {
		...
		return (
			<section id="login" className="text-center container">
				...
				<h3>
				Sign up to create an appbase.io app.
				</h3>
				<p style={{ textAlign: 'left', maxWidth: 650, margin: '20px auto' }}>
					<label style={{ padding: 0, marginBottom: 5 }} htmlFor="tos" className="ad-filter-shareapps checkbox-inline">
						<input style={{ width: 16, height: 16 }} type="checkbox" id="tos" name="tos" checked={tos} onChange={this.handleChange} />
						By creating an account, you agree to our <a href="https://appbase.io/tos" target="_blank">Terms of Service</a> and <a href="https://appbase.io/privacy" target="_blank">Privacy Policy</a>.
					</label>
					<label style={{ padding: 0, margin: 0 }} htmlFor="optIn" className="ad-filter-shareapps checkbox-inline">
						<input style={{ width: 16, height: 16 }} type="checkbox" id="optIn" name="optIn" checked={optIn} onChange={this.handleChange} />
