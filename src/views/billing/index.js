...
export default class Billing extends Component {
	constructor(props, context) {
		...
		const localBillingMode = localStorage.getItem('billingMode');
		...
		const mode =
			localBillingMode && (localBillingMode == 'monthly' || localBillingMode == 'annual')
				? localBillingMode
				: 'annual';
		...
		billingService
			...
			.catch((data) => {
				this.setState({
					show: true,
					text:
						data && data.message && data.message.raw && data.message.raw.message
