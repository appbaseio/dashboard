...
export default class DeleteApp extends Component {
	constructor(props) {
		...
		this.confirmBoxInfo = {
			...
			description: (
				<p>
					Type the app name <strong>{this.props.appName}</strong> below to delete the app.
				...
				<header className="col-xs-12 col-xs-offset-1 pull-right delete-title">
					<summary className="delete-app-container">
						<ConfirmBox
							...
							type="danger"
						>
							<a className="ad-theme-btn danger ad-confirm-btn">Delete App</a>
						</ConfirmBox>
						<aside className="permission-card-body">
							<span className="permission-delete-card-description">
								Deleting an app is a permanent action, and will delete all the
								associated data, credentials and team sharing settings.
							</span>
						</aside>
					</summary>
				</header>
