	...
	constructor(props) {
		...
		this.confirmInfo = {
			...
			description: (
				<p>
					{' '}
					Do you want to abort the import process and go back to the dashboard? The
	...
	render() {
		return (
			<div className="ad-importer">
				<iframe
					src={this.getImporterUrl()}
					frameBorder="0"
					className="ad-importer-iframe"
				/>
				<ConfirmBox info={this.confirmInfo} onConfirm={this.close} type="danger">
