			...
			<div className="onboarding-wrapper">
				<div className="left">
					<header>
						<span>STEPS</span>
						<span>
							{this.state.currentScreen + 1} of {this.state.totalScreen}
						</span>
					</header>
					<div className="meter">
						<div
							className="color"
							style={{
								width: `${((this.state.currentScreen + 1) * 100) /
									this.state.totalScreen}%`,
							}}
						/>
					</div>
					<ul>
						<li>
							<a className={this.state.currentScreen === 0 ? 'active' : null}>
