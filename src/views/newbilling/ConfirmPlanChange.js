...
export default class ConfirmPlanChange extends Component {
					...
					<div className="breakdown">
						...
						{this.props.billingText.payment.amount ? (
							<div className="payment">
								<h5>
									Price for {this.props.customer.plan} plan: ${
										this.props.billingText.payment.amount
									}
								</h5>
								<p className="description">
									({this.props.billingText.payment.explain})
								</p>
							</div>
						) : null}
						{this.props.billingText.refund.amount ? (
							<div className="refund">
								<h5>
									Refund from {this.props.activePlan} plan: ${
										this.props.billingText.refund.amount
									}
								</h5>
								<p className="description">
									({this.props.billingText.refund.explain})
								</p>
							</div>
						) : null}
					</div>
	...
	render() {
		return (
			<Modal
				id="paymentModal"
				show={this.props.showPlanChange}
			...
			>
					...
					<div className="Header-logo">
						<div className="Header-logoWrap">
							...
							<div
								...
								style={{
									backgroundImage:
										"url('../../../assets/images/pricing/stripeLogo.png')",
								}}
								alt="Logo"
							/>
						</div>
				...
				<Modal.Footer>
					<button
						{...common.isDisabled(this.props.loadingModal)}
						type="button"
						className="btn btn-primary col-xs-12 saveBtn"
						onClick={this.props.confirmPlan}
					>
						{this.props.loadingModal ? <Loading /> : null}
						Confirm plan change
					</button>
				</Modal.Footer>
			</Modal>
