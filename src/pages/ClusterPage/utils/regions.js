export default {
	...
	// southeastasia: { name: 'South East Asia', flag: 'canada.png' },
	uksouth: { name: 'Uk South', flag: 'uk.png' },
	northeurope: { name: 'North Europe', flag: 'europe.png' },
	westus2: { name: 'West US', flag: 'united-states.png' },
	westus: { name: 'West US', flag: 'united-states.png' },
	eastus2: { name: 'East US', flag: 'united-states.png' },
};
