...
const esVersions = ['8.3.2', '7.17.5'];

const openSearchVersions = ['2.1.0'];

let interval;

export const V7_ARC = '8.5.0-cluster';
export const V6_ARC = '8.5.0-cluster';
export const ARC_BYOC = '8.5.0-byoc';
