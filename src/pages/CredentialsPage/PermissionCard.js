...
import { keySummary } from '../../utils/helper';
import { Types } from './utils';
import Description from './Description';
import { updatePermission, deletePermission } from '../../batteries/utils/app';
...
export default class PermissionCard extends Component {
	...
	ccSuccess() {
		notification.success({
			message: 'Success',
			description: `${this.state.description} Credentials have been copied successully!`,
		});
			...
			<div className="permission-card col-xs-12 p-0">
				...
				<div className="permission-card-body col-xs-12">
					...
					<div className="col-xs-12 col-sm-9 col-md-9 col-lg-7 permission-card-body-credential">
						<div className="ad-permission-key">
